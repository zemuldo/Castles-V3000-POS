...
int withdraw_post(BYTE pin[4],BYTE amount[5], BYTE recipientcardtype[255], BYTE receipentcardno[17], BYTE recipientCardexpiry_date[6]) {
	...
	cJSON_AddItemToObject(root, "username", cJSON_CreateString("familypos"));
        ...
        cJSON_AddItemToObject(root, "merchantCard", cJSON_CreateString(receipentcardno));
        cJSON_AddItemToObject(root, "merchantCVV", cJSON_CreateString("343"));
        //cJSON_AddItemToObject(root, "merchantPin", cJSON_CreateString(pin));
        //cJSON_AddItemToObject(root, "merchantcard_type", cJSON_CreateString(recipientcardtype));
        //cJSON_AddItemToObject(root, "merchantCardexpiry_date", cJSON_CreateString(recipientCardexpiry_date));
         cJSON_AddItemToObject(root, "recipientCard", cJSON_CreateString(receipentcardno));
        ...
        cJSON_AddItemToObject(root, "recipientPin", cJSON_CreateString(pin));
         cJSON_AddItemToObject(root, "accountnumber", cJSON_CreateString(receipentcardno));
