...
void agentprintbal(char *balanceret){
    agent_receipt(&stRCDataEx, NeedSignature, balanceret);
}

void agent_receipt(EMVCL_RC_DATA_EX *data, BYTE isNeedSignature, char *bal) {
    //------------------------------------------------------
    //PrintBlank();
