...
void printbal(char *balanceret){
    printballane_receipt(&stRCDataEx, NeedSignature, balanceret);
}

void printballane_receipt(EMVCL_RC_DATA_EX *data, BYTE isNeedSignature, char *bal) {
    //------------------------------------------------------
    //PrintBlank();
